...
- Mantıksal `1080×1920` tuvalde Short animasyon bölgesinin alt sınırı 880 px, seçenek A'nın üst sınırı 930 px; en az 50 px görsel boşluk vardır. Final `720×1280` çıktıda karşılıkları yaklaşık 587 px ve 620 px'tir. Nihai önizlemede tam hareket aralığı yeniden ölçülmelidir.
