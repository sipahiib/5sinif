...
DATA=json.loads((ROOT/"content/cevresorunlarimiz_afetler.json").read_text())
BASE=ROOT/"public/audio/sosyal/cevresorunlarimiz_afetler"
...
async def main():
    ...
    out=ROOT/"src/cevresorunlarimiz-afetler/timings.json"
