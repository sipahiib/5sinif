# Hücreye özgü render QA noktaları

Ses üretiminden sonra `src/hucre/timings.json` değerleri esas alınır.

- Ana video: her sahnenin başlangıcı, +15 ve son -1 karesi.
...
- Aşağıdaki bölge değerleri mantıksal `1080×1920` composition tuvaline aittir; final `720×1280` incelemesinde `2/3` ile ölçeklenir: soru kartı 125–445, animasyon 475–805, seçenekler 835–1288, İbrahim sağ güvenli alan 772–1064 / 900–1410, sayaç 1530–1810, başarı kartı 1450–1845. Yatay ayrışma nedeniyle karakter ve seçenekler birleşmez; başarı durumunda görünür karakter başarı kartının üst sınırında kalır.
