...
const render=(id,path)=>execFileSync("npx",["remotion","render","src/konum/entry.tsx",id,path,"--scale=0.6666666667","--codec=h264","--crf=18","--concurrency=5","--log=error"],{stdio:"inherit"});
render("Konum",`${out}/konum.mp4`);render("KonumKurz",`${out}/konum_kurz.mp4`);render("KonumShorts1",`${short}/konum_shorts.mp4`);
execFileSync("npx",["remotion","still","src/konum/entry.tsx","KonumKurzCover",`${out}/konum_kurz_kapak.png`,"--log=error"],{stdio:"inherit"});
